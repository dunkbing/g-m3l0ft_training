...
#else
					mService = IStoreInAppService.Stub.asInterface(service);
#endif
...
#if YANDEX_STORE
			Intent serviceIntent = new Intent("com.yandex.store.service.StoreInAppService.BIND");
			serviceIntent.setPackage("com.yandex.store");
#elif BAZAAR_STORE
