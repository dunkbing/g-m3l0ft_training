...
public class GMPUtils
{
	...
	public static final int IABHELPER_FREEDOM_DETECTED = -1008;
	public static final int IABHELPER_ITEM_ALREADY_OWNED = -1009;
	public static final int IABHELPER_UNKNOWN_ERROR = -1010;
		...
		protected Integer doInBackground(final Bundle bundle) 
		{
			...
			catch(Exception exc)
			{
				...
				{					
					...
					//Error code
					String message =  getResponseDesc(GMPUtils.IABHELPER_UNKNOWN_ERROR);
					bundle.putByteArray(InAppBilling.GET_STR_CONST(IAB_TP_ERROR),(message!=null)?message.getBytes():null);				
					bundle.putInt(InAppBilling.GET_STR_CONST(IAB_TP_ERROR_CODE), GMPUtils.IABHELPER_UNKNOWN_ERROR);
   ...
   /**
    ...
    public String getResponseDesc(int code) 
	{
        ...
        String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/" +
                                   ...
                                   "-1007:Missing token/" +
                                   "-1008:Dubious activity/" +
                                   "-1009:Item already owned/" +
                                   "-1010:Unknown error").split("/");
