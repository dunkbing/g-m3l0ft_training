...
:main
	...
	rem call %~dp0wget.exe  --quiet -O %temp%\%NDKArchive% http://dl.google.com/android/ndk/android-ndk-r8e-windows-x86.zip
	svn export https://svn01/vc/gllegacy/release_v2.0/trunk/tools/sdk/android-ndk-r8e-windows-x86.zip  %temp%\%NDKArchive% --quiet --force
	if %ERRORLEVEL% == 1 ( 
		@echo off
