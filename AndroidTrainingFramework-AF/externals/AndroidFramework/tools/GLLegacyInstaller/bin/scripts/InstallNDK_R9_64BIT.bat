...
:main
	...
	rem call %~dp0wget.exe  --quiet -O %temp%\%NDKArchive% https://svn01/vc/gllegacy/release_v2.0/trunk/tools/sdk/android-ndk-r9-windows-x86_64.zip
	svn export https://svn01/vc/gllegacy/release_v2.0/trunk/tools/sdk/android-ndk-r9-windows-x86_64.zip  %temp%\%NDKArchive% --quiet --force
	pause
	if %ERRORLEVEL% == 1 ( 
		@echo off
