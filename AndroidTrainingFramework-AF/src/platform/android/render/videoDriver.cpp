...
void VideoDriver::Init()
{
	...
	if (!program)
	{
		LOG_ERROR("Cannot create program COLOR\n");
		exit(0);
	}
...
//void VideoDriver::DrawLine(Vec2i pos0, Vec2i pos1)
//{
//	float* vertices = new float[4];
//	vertices[0] = X2GAME(pos0.x);
//	vertices[1] = Y2GAME(pos0.y);
//	vertices[2] = X2GAME(pos1.x);
//	vertices[3] = Y2GAME(pos1.y);
